...
public class JefeEmpleado implements Empleados {
	...
	public void metodoInicial () {
		//tareas que se ejecutan antes de que el bean esté disponible, abrir sockets...etc.
		System.out.println("Dentro del metodo init, aqui irian las tareas a ejecutar antes de que el bean esté listo");
	}
