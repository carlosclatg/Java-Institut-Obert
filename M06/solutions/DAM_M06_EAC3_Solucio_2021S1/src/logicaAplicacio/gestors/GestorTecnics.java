...
public class GestorTecnics {
    ...
    public List<Tecnics> obtenirTecnics() {
       Query q = em.createNamedQuery("Tecnics.tots");

       List<Tecnics> resultat=q.getResultList();
       for(Tecnics e:resultat){
           em.detach(e);
       }
       return resultat;
    }
    ...
    public List<Tecnics> obtenirTecnicsUnInsti(int codiInsti) {
       Query q = em.createNamedQuery("Tecnics.institut");
       q.setParameter("codi", codiInsti);
       List<Tecnics> resultat=q.getResultList();
       for(Tecnics e:resultat){
           em.detach(e);
       }
    ...
    public List<Tecnics> obtenirTecnicsPerEspecialitat(String formacio) {
       Query q = em.createNamedQuery("Tecnics.perEspecialitat");
       q.setParameter("especialitat", formacio);
       List<Tecnics> resultat=q.getResultList();
       for(Tecnics e:resultat){
           em.detach(e);
       }
    ...
    public List<Tecnics> obtenirTecnicsPerSou(float sou) {
       Query q = em.createNamedQuery("Tecnics.segonsSou");
       q.setParameter("sou", sou);
       List<Tecnics> resultat=q.getResultList();
       for(Tecnics e:resultat){
           em.detach(e);
       }
