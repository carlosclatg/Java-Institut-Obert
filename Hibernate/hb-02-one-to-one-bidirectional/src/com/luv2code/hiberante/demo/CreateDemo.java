...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Instructor tempInstructor = new Instructor("Carlos", "Calvo", "carlos@mail.com");
			...
			//create a Instructor and Detail
			Instructor tempInstructor1 = new Instructor("Cesc", "Calvo", "cesc@mail.com");
			InstructorDetail tempInstructorDetail1 = new InstructorDetail("canalyoutube", "I love gym");
